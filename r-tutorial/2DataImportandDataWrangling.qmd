...
# 📘 Chapter 2: Data Import and Data Wrangling
...
library(readr)
rcar_data <- read_csv("D:/DemoPractices/R for Data Science/data/car data.csv")
names(car_data)
```
...
-   [csv - base R]{style="color:red"}: `read.csv("path/file.csv")`\
-   [csv - readr]{style="color:red"}: `read_csv("path/file.csv")` from the readr package\
-   [stata]{style="color:red"}: `read_dta("path/file.dta")` from the haven package\
-   [spss]{style="color:red"}: `read_sav("path/file.sav")` from the haven package\
-   [excel]{style="color:red"}: `read_excel("path/file.xlsx")` from the readxl package\
-   [excel (sheet 2)]{style="color:red"}: `read_excel("path/file.xlsx", sheet = 2)`\
-   [rds]{style="color:red"}: `readRDS("path/file.rds")` for single R object
...
## 📚 Further Resources (for Data Import & Wrangling)
